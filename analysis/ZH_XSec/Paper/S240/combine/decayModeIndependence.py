...
if __name__ == "__main__":
    ...
    outDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/FinalReport/S240/%s/plots_checks/" % flavor 
    ...
    for i,cut in enumerate(cuts):
        ...
        print("y_ref_tot", y_ref_tot, y_ref_tot_err)
        print("y_cut_tot", y_cut_tot, y_cut_tot_err)
        sel_eff_tot = y_cut_tot / y_ref_tot
        sel_eff_tot_err = sel_eff_tot * ( (y_cut_tot_err/y_cut_tot)**2 + (y_ref_tot_err/y_ref_tot)**2)**0.5
        print("sel_eff_tot", sel_eff_tot, sel_eff_tot_err)
