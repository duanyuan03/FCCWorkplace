...
if __name__ == "__main__":
    ...
    baseFileName = "/gpfs/mnt/gpfs01/usfcc/ali3/storage/ZH_XSec_Paper/S240/" + flavor + "/BDT_analysis_samples/syst/{sampleName}_{selection}_histo.root"
    hName = "BDT_Score"
    runDir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "run_binned_BDTScore_{flavor}".format(flavor=flavor))
    outDir = "/gpfs/mnt/gpfs01/usfcc/ali3/storage/ZH_XSec_Paper/S240/{flavor}/combine_binned_BDTScore".format(flavor=flavor)
