...
inputDir = _sdir(240, "ee", "BDT_analysis_samples")

#Input directory where the files produced at the pre-selection level are
outputDir = _sdir(240, "ee", "BDT_analysis_samples/syst")
...
cutList = { "sel0":"return true;",
            ...
            "sel_Baseline_loBDT":"zll_m > 86 && zll_m < 96 && zll_recoil_m > 100 && zll_recoil_m < 150 && zll_p > 20 && BDTscore < 0.88",
            "sel_Baseline_hiBDT":"zll_m > 86 && zll_m < 96 && zll_recoil_m > 100 && zll_recoil_m < 150 && zll_p > 20 && BDTscore >= 0.88",
