...
formats        = ['pdf','png']
#yaxis          = ['lin']
outdir         = '/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/FinalReport/S240/mumu/BDT_analysis_samples/ECFA_plots/'
...
extralabel["sel_Baseline_no_costhetamiss"]            = "Basic Selection"   
