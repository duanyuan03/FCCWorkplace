"""
Prepare the ZH hadronic (Z->qq) BDT training set (ecm 240) from the stage1 training
...
hadronic reference training (FCCPhysics zh_hadronic_training/train.py):
...
SIG_LUMI_FRAC = 0.2    # equal effective lumi per Higgs decay (reference: 0.2 * intLumi at 240)
