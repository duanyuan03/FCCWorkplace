# Stage2 for the ZH hadronic (Z->qq) channel, ecm 240: BDT-score (and control)
...
#
# Run: fccanalysis final analysis/ZH_XSec/Paper/S240/qq/stage2_histograms_syst.py
import glob
import os, sys
...
_bins2d = [(25, 100, 150), (24, 20, 140)]   # (recoil), (m_jj)
_h2 = {
...
histoList = {
    ...
    "recoil_m":     {"name": "zqq_recoil_m_best", "title": "Recoil mass (GeV)", "bin": 100, "xmin": 100, "xmax": 150},
    "zqq_m":        {"name": "zqq_m_best",        "title": "m_{qq} (GeV)",      "bin": 120, "xmin": 20,  "xmax": 140},
    "zqq_p":        {"name": "zqq_p_best",        "title": "p_{qq} (GeV)",      "bin": 70,  "xmin": 20,  "xmax": 90},
