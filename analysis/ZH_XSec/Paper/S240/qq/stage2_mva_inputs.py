# Stage2 over the qq TRAINING trees (winter2023_training campaign, ecm 240):
...
#
# Run: fccanalysis final analysis/ZH_XSec/Paper/S240/qq/stage2_mva_inputs.py
import glob
import os, sys
...
histoList = {
    "zqq_p_best":            {"name": "zqq_p_best",            "title": "p_{qq} (GeV)",            "bin": 70,  "xmin": 20,  "xmax": 90},
    "zqq_m_best":            {"name": "zqq_m_best",            "title": "m_{qq} (GeV)",            "bin": 120, "xmin": 20,  "xmax": 140},
    "zqq_recoil_m_best":     {"name": "zqq_recoil_m_best",     "title": "Recoil mass (GeV)",       "bin": 100, "xmin": 100, "xmax": 150},
    "leading_jet_p":         {"name": "leading_jet_p",         "title": "p_{j_{1}} (GeV)",         "bin": 100, "xmin": 0,   "xmax": 130},
    "subleading_jet_p":      {"name": "subleading_jet_p",      "title": "p_{j_{2}} (GeV)",         "bin": 100, "xmin": 0,   "xmax": 100},
    ...
    "W1_p":                  {"name": "W1_p",                  "title": "p_{W_{1}} (GeV)",         "bin": 100, "xmin": 0,   "xmax": 120},
    "W2_p":                  {"name": "W2_p",                  "title": "p_{W_{2}} (GeV)",         "bin": 100, "xmin": 0,   "xmax": 120},
    "W1_m":                  {"name": "W1_m",                  "title": "m_{W_{1}} (GeV)",         "bin": 100, "xmin": 0,   "xmax": 150},
    "W2_m":                  {"name": "W2_m",                  "title": "m_{W_{2}} (GeV)",         "bin": 100, "xmin": 0,   "xmax": 150},
