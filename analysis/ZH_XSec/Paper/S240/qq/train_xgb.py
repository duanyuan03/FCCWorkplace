"""
Train the ZH hadronic BDT (ecm 240) on the preprocessed training set
(process_sig_bkg_samples_for_xgb.py -> training/preprocessed.pkl).

Adapted from FCCPhysics zh_hadronic_training/train.py (hyperparameters
...
the pre-trained MIT model bdt_model_ecm240.root.
