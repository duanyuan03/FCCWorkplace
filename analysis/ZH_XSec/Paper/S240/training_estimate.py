...
def run(channel, modes, n_folds, stage):
  loc, train_vars, mode_names, _, _ = make(240, channel)
  ...
  # producer on SDCC: python condor/submit_stage1.py S240/<flavor>/stage1_training_estimate.py --stage training_estimation
