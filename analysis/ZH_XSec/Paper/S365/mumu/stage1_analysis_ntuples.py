...
processList = {
    #signal
    "wzp6_ee_mumuH_ecm365":{'chunks':20},
    #signal mass
    #"wzp6_ee_mumuH_mH-higher-100MeV_ecm365":{'chunks':20},
    #"wzp6_ee_mumuH_mH-higher-50MeV_ecm365":{'chunks':20},
    #"wzp6_ee_mumuH_mH-lower-100MeV_ecm365":{'chunks':20},
    #"wzp6_ee_mumuH_mH-lower-50MeV_ecm365":{'chunks':20},
    #signal syst
    "wzp6_ee_mumuH_BES-higher-1pc_ecm365":{'chunks':20},
    "wzp6_ee_mumuH_BES-lower-1pc_ecm365":{'chunks':20},
    "wzp6_ee_mumuH_BES-higher-10pc_ecm365":{'chunks':20},
    "wzp6_ee_mumuH_BES-lower-10pc_ecm365":{'chunks':20},
    #background: 
    "p8_ee_WW_ecm365":{'chunks':80},
    "p8_ee_ZZ_ecm365":{'chunks':20},
    "wzp6_ee_mumu_ecm365":{'chunks':20},
    "wzp6_ee_tautau_ecm365":{'chunks':20},
    #rare backgrounds:
    "wzp6_egamma_eZ_Zmumu_ecm365":{'chunks':20},
    "wzp6_gammae_eZ_Zmumu_ecm365":{'chunks':20},
    "wzp6_gaga_mumu_60_ecm365":{'chunks':20},
    "wzp6_gaga_tautau_60_ecm365":{'chunks':20},
    "wzp6_ee_nuenueZ_ecm365":{'chunks':20},
...
outputDirEos= "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/TopHiggs/mumu/BDT_analysis_samples/"
eosType = "eosuser"
...
userBatchConfig=None  # unused on SDCC (custom group_usfcc submitter); was a CERN /afs path
#USER DEFINED CODE
import ROOT, os, sys
# site-aware model path: GPFS copy on SDCC, original /eos on lxplus
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", ".."))
from site_config import bdt_model
ROOT.gInterpreter.ProcessLine(f'''
  TMVA::Experimental::RBDT<> bdt("ZH_Recoil_BDT", "{bdt_model(365, "mumu")}");
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (
            ...
            .Define("leps_all_iso", "HiggsTools::coneIsolationTheta(0.01, 0.5)(leps_all, ReconstructedParticles)") 
            ...
            .Define("leps_iso", "HiggsTools::coneIsolationTheta(0.01, 0.5)(leps, ReconstructedParticles)")
            ...
            .Define("zll_leps_dR", "HiggsTools::deltaRPrime(zll_leps)")  # theta-based (deltaR uses eta)
            ...
            .Define("zbuilder_result_scaleup", "HiggsTools::resonanceBuilder_mass_recoil(91.2, 125, 0.4, 365, false)(leps_scaleup, MCRecoAssociations0, MCRecoAssociations1, ReconstructedParticles, Particle, Particle0, Particle1)")
            .Define("zll_scaleup", "ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData>{zbuilder_result_scaleup[0]}")
            .Define("zll_recoil_scaleup", "FCCAnalyses::ReconstructedParticle::recoilBuilder(365)(zll_scaleup)")
            ...
            .Define("zbuilder_result_scaledw", "HiggsTools::resonanceBuilder_mass_recoil(91.2, 125, 0.4, 365, false)(leps_scaledw, MCRecoAssociations0, MCRecoAssociations1, ReconstructedParticles, Particle, Particle0, Particle1)")
            .Define("zll_scaledw", "ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData>{zbuilder_result_scaledw[0]}")
            .Define("zll_recoil_scaledw", "FCCAnalyses::ReconstructedParticle::recoilBuilder(365)(zll_scaledw)")
            ...
            # sqrt uncertainty
            .Define("zll_recoil_sqrtsup", "FCCAnalyses::ReconstructedParticle::recoilBuilder(365.002)(zll)")
            .Define("zll_recoil_sqrtsdw", "FCCAnalyses::ReconstructedParticle::recoilBuilder(364.998)(zll)")
