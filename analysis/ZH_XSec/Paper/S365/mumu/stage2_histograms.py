...
inputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/TopHiggs/mumu/BDT_analysis_samples"

#Input directory where the files produced at the pre-selection level are
outputDir = "/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/TopHiggs/mumu/BDT_analysis_samples/final"
...
cutList = { 
            ...
            # Figure 4 and 5
            "sel_Baseline_without_mrec":"zll_m > 86 && zll_m < 96 && zll_p > 20 && cosTheta_miss.size() >=1 && cosTheta_miss[0] > -0.98 && cosTheta_miss[0] < 0.98",
            "sel_Baseline_without_mrec_1":"zll_m > 86 && zll_m < 96 && zll_p > 20",
            "sel_Baseline_without_mrec_2":"zll_m > 86 && zll_m < 96",
            "sel_Baseline_without_mrec_3":"zll_p > 20",
