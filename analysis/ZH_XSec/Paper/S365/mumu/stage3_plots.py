...
energy         = 365.0
collider       = 'FCC-ee'
inputDir       = '/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/TopHiggs/mumu/BDT_analysis_samples/final/'
#formats        = ['png','pdf']
yaxis          = ['lin','log']
#yaxis          = ['lin']
...
#yaxis          = ['lin']
outdir         = '/eos/experiment/fcc/ee/analyses_storage/Higgs_and_TOP/mass_xsec/lia/FCCee/TopHiggs/mumu/BDT_analysis_samples/plots/'
...
plots['ZH'] = {'signal':{'mumuH':['wzp6_ee_mumuH_ecm365']},
               'backgrounds':{'eeZ':["wzp6_egamma_eZ_Zmumu_ecm365",
