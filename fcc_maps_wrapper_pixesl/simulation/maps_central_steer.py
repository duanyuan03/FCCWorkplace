"""
maps_central_steer.py - CENTRAL-MATCHED steering (FTFP_BERT, default range
cut, 1 keV tracker filter, NO low-E EM commands) for like-for-like chain
validation against the central mdi_v2 production. NOT the BIB recipe.
